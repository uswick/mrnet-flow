...
MRNET_LIBS = ${REPO_PATH}/mrnet/lib/libmrnet.a.4.0.0  ${REPO_PATH}/mrnet/lib/libxplat.a.4.0.0 -lm -lpthread -ldl -lboost_system -lboost_timer


all: dataTest

schema.o: schema.C data.h schema.h
	g++ -g ${CXXFLAGS} -I/usr/include schema.C -c -o schema.o

data.o: data.C data.h schema.h
	g++ -g ${CXXFLAGS} -I/usr/include data.C -c -o data.o

operator.o: operator.C operator.h data.h schema.h
	g++ -g ${CXXFLAGS} -I/usr/include operator.C -c -o operator.o

process.o: process.C process.h sight_common_internal.h
	g++ -g ${CXXFLAGS} -I/usr/include process.C -c -o process.o

sight_common.o: sight_common.C process.h sight_common_internal.h
	g++ -g ${CXXFLAGS} -I/usr/include sight_common.C -c -o sight_common.o

utils.o: utils.C utils.h
	g++ -g ${CXXFLAGS} -I/usr/include utils.C -c -o utils.o

dataTest: dataTest.C *.h schema.o data.o operator.o process.o sight_common.o utils.o
	g++ -g ${CXXFLAGS} -I/usr/include dataTest.C schema.o data.o operator.o process.o sight_common.o utils.o -o dataTest
...
mrnet_operator.o: mrnet_operator.C mrnet_operator.h mrnet_flow.h
	g++ -g ${MRNET_CXXFLAGS} -I/usr/include mrnet_operator.C -c -o mrnet_operator.o

filter_init.o: mrnet_operator.h mrnet_flow.h filter_init.h
	g++ -g  ${MRNET_CXXFLAGS} -I/usr/include filter_init.C -c -o filter_init.o

front: front.C mrnet_operator.o *.h schema.o data.o operator.o process.o sight_common.o utils.o
	g++ -g ${MRNET_CXXFLAGS} -I/usr/include front.C mrnet_operator.o schema.o data.o operator.o process.o sight_common.o utils.o -o front ${MRNET_LIBS}

backend: backend.C mrnet_operator.o *.h schema.o data.o operator.o process.o sight_common.o utils.o
	g++ -g ${MRNET_CXXFLAGS} -I/usr/include backend.C mrnet_operator.o schema.o data.o operator.o process.o sight_common.o utils.o -o backend ${MRNET_LIBS}

filter.so: filter.C mrnet_operator.o filter_init.o *.h schema.o data.o operator.o process.o sight_common.o utils.o
	g++ -g ${MRNET_CXXFLAGS} ${MRNET_SOFLAGS} -I/usr/include filter.C mrnet_operator.o filter_init.o schema.o data.o operator.o process.o sight_common.o utils.o -o filter.so ${MRNET_LIBS}
